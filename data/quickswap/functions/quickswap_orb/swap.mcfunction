...
execute if data entity @s SelectedItem.tag.Quickswap.StoredChestplate.id run item modify entity @s weapon.mainhand quickswap:fix_slot
...
execute unless score #unbreakable qs.options matches 1 run function quickswap:quickswap_orb/use_durability
